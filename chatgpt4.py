...
if uploaded_file :
    ...
    chain = ConversationalRetrievalChain.from_llm(llm = ChatOpenAI(temperature=0.0,model_name='gpt-3.5-turbo', openai_api_key=user_api_key),
                                                                      retriever=vectors.as_retriever(search_kwargs={"k": 100})) ## this kind of sets the amount of tokens used
    ...
    if 'generated' not in st.session_state:
        st.session_state['generated'] = ["Ask me questions about " + uploaded_file.name ]
